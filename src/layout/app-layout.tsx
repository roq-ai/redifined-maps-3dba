...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'system-administrator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Traffic', path: '/traffic', entity: 'traffic', service: AccessServiceEnum.PROJECT, icon: FiBox },
