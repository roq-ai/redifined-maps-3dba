...
import { createPetrolStation } from 'apiSdk/petrol-stations';
...
function PetrolStationCreatePage() {
  ...
  const handleSubmit = async (values: PetrolStationInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createPetrolStation(values);
      resetForm();
