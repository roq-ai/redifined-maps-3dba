...
export function LocationListPage(props: LocationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getLocations({
        relations: ['user', 'petrol_station.count', 'restaurant.count', 'traffic.count', 'vehicle.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('petrol_station', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'petrol_station',
          header: 'Petrol Station',
          accessorKey: 'petrol_station',
          cell: ({ row: { original: record } }: any) => record?._count?.petrol_station,
        }
      : null,
    hasAccess('restaurant', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.restaurant,
        }
      : null,
    hasAccess('traffic', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'traffic',
          header: 'Traffic',
          accessorKey: 'traffic',
          cell: ({ row: { original: record } }: any) => record?._count?.traffic,
        }
      : null,
